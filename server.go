...
// Data structure representing the page title & body
type Page struct {
	Title string
...
// save Method to save a text file to the system
...
// makeHandler Wrapper funtion to take a handler function & return a http.ResponseWriter function
...
// saveHandler Handle submission of forms from the edit page
